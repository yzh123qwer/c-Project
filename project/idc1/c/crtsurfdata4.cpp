/* 
 * 程序名：crtsurfdata4.cpp 本程序用于生成全国气象站点每分钟生成的数据
 * 作者：姚子涵
*/
#include"_public.h"
...
int main(int argc, char *argv[])
{
  ...
  { // 如果参数非法，给出帮助文档
    ...
    printf("Example:/root/project/idc1/bin/crtsurfdata4 /root/project/idc1/ini/stcode.ini /tmp/surfdata /log/idc/crtsurfdata4.log xml,json,csv\n\n");
