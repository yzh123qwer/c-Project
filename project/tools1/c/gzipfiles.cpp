...
int main(int argc, char *argv[])
{
  ...
  {
    printf("\n");
    printf("Using: /root/project/tools1/bin/gzipfiles pathname matchstr timeout\n\n");
    printf("Example: /root/project/tools1/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf("         /root/project/tools1/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n");
    printf("         /root/project/tools1/bin/procctl 300 /root/project/tools1/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf("         /root/project/tools1/bin/procctl 300 /root/project/tools1/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n\n");
