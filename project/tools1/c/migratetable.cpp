...
void _help(char *argv[])
{
  printf("Using:/root/project/tools1/bin/migratetable logfilename xmlbuffer\n\n");

  printf("Sample:/root/project/tools1/bin/procctl 3600 /root/project/tools1/bin/migratetable /log/idc/migratetable_ZHOBTMIND.log \"<connstr>192.168.188.100,123456,mysql,3306</connstr><srctname>T_ZHOBTMIND</srctname><dsttname>T_ZHOBTMIND_HIS</dsttname><keycol>keyid</keycol><where>where ddatetime<timestampadd(minute,-120,now())</where><starttime>01,02,03,04,05,13</starttime><maxcount>300</maxcount><timeout>120</timeout><pname>migratetable_ZHOBTMIND</pname>\"\n\n");
