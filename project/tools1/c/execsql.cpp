...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/root/project/tools1/bin/procctl 120 /root/project/tools1/bin/execsql /root/project/idc1/sql/cleardata.sql \"192.168.188.100,root,123456,mysql,3306\" utf8 /log/idc/execsql.log\n\n");
